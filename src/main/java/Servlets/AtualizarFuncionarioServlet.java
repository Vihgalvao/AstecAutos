        ...
        try {
            if (metodo.equals("atualizar")) {
                ...
                RequestDispatcher dispatcher
                        = request.getRequestDispatcher("WEB-INF/Funcionario/resultadoAtualizarFunc.jsp");
                ...
                request.setAttribute("FuncionarioUpdate", p1);
                RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/Funcionario/resultadoDeleteFunc.jsp");
                dispatcher.forward(request, response);
